...
Note: 
  This model uses skid steering, meaning, each side has its motors connected in parallel to each other, just like on a tank. If you want to make it smoother check [Improvements](./Improvements) 
